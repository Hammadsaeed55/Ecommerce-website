      ...
      <div className=' max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
        <form onSubmit={handleLogin} action="" className=' w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
          ...
          <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]'>
            ...
            />
            {
              !show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute right-[35%] bottom-[32%]' onClick={() => setShow(prev => !prev)} />
            }
            {
              show && < FaEyeSlash className='bottom-[32%] w-[20px] h-[20px] cursor-pointer absolute right-[35%]' onClick={() => setShow(prev => !prev)} />
            }
