...
const NewLetterBox = () => {
  ...
  return (
    <div className='w-[100%] h-[50vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start md:gap-[10px] gap-[3px] flex-col'>
      ...
      <form  onClick={handleSubmit} action="" className='w-[100%] h-[30%] md:h-[50%] flex items-center justify-center mt-[20px] gap-[20px] px-[20px] '>
        <input type="text" name="" id="" className='placeholder:text-[black] bg-slate-300 w-[600px] max-w-[60%] h-[40px] px-[20px] rounded-lg shadow-sm shadow-black' placeholder='Enter Your Email' required />
